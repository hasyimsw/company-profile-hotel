    ...
    return (
        <div className='bg-white shadow-2xl min-h-[500px] group'>
            ...
            <div className='text-center'>
                ...
                <p className='max-w-[300px] mx-auto mb-3 lg:mb-6 text-sm text-slate-500'>{description.substring(0, 60)}...<Link to={`/room/${id}`} className='ml-1 underline cursor-pointer text-sky-500 hover:text-sky-600'>see more</Link></p>
            </div>
            {/* button */}
